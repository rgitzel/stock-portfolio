...
object ClosingPrice {
  def apply(stock: Stock, monetaryValue: MonetaryValue): ClosingPrice =
    ClosingPrice(stock, monetaryValue.currency, monetaryValue.value)
}
